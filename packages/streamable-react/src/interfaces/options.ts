...
export interface PipeableStreamOptions extends BootstrapOptions, NonceOptions {
    /**
...
export interface StreamableOptions<T = Record<string, unknown>> extends EventHandlers, BootstrapOptions, NonceOptions {
    /**
     * The React component to render.
     */
