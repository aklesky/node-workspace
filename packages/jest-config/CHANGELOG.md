...
- Updated @aklesky/eslint-prettier-config to 1.0.2
...
- Updated @aklesky/eslint-prettier-config to 1.0.1
- Updated @aklesky/eslint-config to 1.0.1
...
- **react-preset:** add metaAttributes property to middleware config … ([#220](https://github.com/aklesky/node-workspace/pull/220))
- **react-preset:** add metaAttributes property to middleware config ([#219](https://github.com/aklesky/node-workspace/pull/219))
...
- **deps:** update dependency @swc/core to v1.3.90 ([#169](https://github.com/aklesky/node-workspace/pull/169))
- ⚠️ **ts-config:** Ensure typescript configuration is up to date ([#170](https://github.com/aklesky/node-workspace/pull/170))
- **deps:** update dependency @swc/core to v1.3.87 ([#154](https://github.com/aklesky/node-workspace/pull/154))
- **deps:** update jest monorepo ([#150](https://github.com/aklesky/node-workspace/pull/150))
- **deps:** update jest monorepo ([#136](https://github.com/aklesky/node-workspace/pull/136))
- **deps:** update swc monorepo ([#129](https://github.com/aklesky/node-workspace/pull/129))
- **deps:** update dependency @swc/core to v1.3.66 ([#119](https://github.com/aklesky/node-workspace/pull/119))
- **deps:** update dependency rimraf to v5 ([#118](https://github.com/aklesky/node-workspace/pull/118))
- **deps:** update swc monorepo ([#107](https://github.com/aklesky/node-workspace/pull/107))
- **deps:** update dependency rimraf to v4.4.0 ([#83](https://github.com/aklesky/node-workspace/pull/83))
- **deps:** update dependency @swc/core to v1.3.39 ([#81](https://github.com/aklesky/node-workspace/pull/81))
- **deps:** update dependency rimraf to v4.3.0 ([#80](https://github.com/aklesky/node-workspace/pull/80))
- **deps:** update dependency @swc/core to v1.3.37 ([#65](https://github.com/aklesky/node-workspace/pull/65))
- **deps:** update dependency @swc/core to v1.3.34 ([#56](https://github.com/aklesky/node-workspace/pull/56))
